  ...
  if (allQuestionsAnswered) {
    return (
      <div className="container mx-auto px-4 py-8 max-w-4xl flex justify-center items-center min-h-[50vh]">
        <Card className="w-full sm:max-w-md bg-green-100 dark:bg-green-900 shadow-lg">
          <CardHeader>
            <CardTitle className="text-lg text-green-800 dark:text-green-300">
              🎉 You've answered all the questions!
            </CardTitle>
            <CardDescription className="text-gray-600 dark:text-gray-400">
              Great job! Come back later for more challenges.
            </CardDescription>
          </CardHeader>
          <CardContent className="flex justify-center">
            <ThumbsUp className="w-16 h-16 text-green-500 dark:text-green-300" />
          </CardContent>
